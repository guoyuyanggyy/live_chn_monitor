...
//获取时间向前推n天
function getQuarterDataTime(Qn,flag) {
	var now = new Date();
	var year = now.getFullYear(); // 年
	var clock="";
    switch(Qn){
      case "q1":
    	if(flag=="b"){  
	    	year=year-1;
	    	clock =year+ "-" +"12"+ "-"+"26"+" "+"00:00:01";
    	}else{
	    	clock =year+ "-" +"03"+ "-"+"25"+" "+"23:59:59";
    	}
    	break;
      case "q2":
      	if(flag=="b"){  
  	    	clock =year+ "-" +"03"+ "-"+"26"+" "+"00:00:00";
      	}else{
  	    	clock =year+ "-" +"06"+ "-"+"25"+" "+"23:59:59";
      	}
      	break;
      case "q3":
      	if(flag=="b"){  
  	    	clock =year+ "-" +"06"+ "-"+"26"+" "+"00:00:00";
      	}else{
  	    	clock =year+ "-" +"09"+ "-"+"25"+" "+"23:59:59";
      	}
      	break;
      case "q4":
      	if(flag=="b"){  
  	    	clock =year+ "-" +"09"+ "-"+"26"+" "+"00:00:00";
      	}else{
  	    	clock =year+ "-" +"12"+ "-"+"25"+" "+"23:59:59";
      	}
      	break;
    }
	return (clock);
...
function loadDatetimePicker(objStart,objEnd,beginDay){
	...
	objEnd.datetimepicker({
	 ...
	 objStart.datetimepicker('setEndDate', getCurentTime()); 
	 objEnd.datetimepicker('setStartDate',getCurentTime());  
	 objStart.val(getDataTime(beginDay));
	 objEnd.val(getCurentTime());
}
